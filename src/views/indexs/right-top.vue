...
export default {
    ...
    methods: {
        ...
        updateOverview(data) {
            ...
            this.countUserNumData = data.recent_count;
            this.$nextTick(() => {
                this.init(data.recent_count.datelist, data.recent_count.applylist, data.recent_count.authlist),
                    this.switper();
            });
        },
        ...
        getData() {
            ...
            currentGET("big4").then((res) => {
                ...
                if (res.success) {
                    ...
                    console.log("[RIGHT TOP] :", this.countUserNumData);
                    this.$nextTick(() => {
